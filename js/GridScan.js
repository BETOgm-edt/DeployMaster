...
export function initGridScan(container, options = {}) {
  ...
  const {
    sensitivity = 0.55,
    lineThickness = 1,
    linesColor = '#132b21', // Subtle dark emerald grid lines matching Obsidian background
    scanColor = '#34D399',  // Exact Emerald Pulse color of "ONLINE" status badge
    scanOpacity = 0.6,
    gridScale = 0.1,
    lineStyle = 'solid',
    lineJitter = 0.1,
  ...
  try {
    ...
    console.warn("WebGL not supported for GridScan:", err);
    return null;
  }
